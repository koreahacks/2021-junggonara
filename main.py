...
async def 왕게임(ctx):
    ...
    if GAME == "게임 종료":
        ...
        try:
            await client.wait_for('YEONTTUK_MESSAGE_TIME', timeout=10.0)
            ...
            if int(LIST_COUNT) <= int(0):
                ...
                try:
                    await client.wait_for("YEONTTUK_TIME", timeout=30)
                except  asyncio.TimeoutError:
...
client.run('Nzk3MjgzOTUwODk2MDg3MTAx.X_kOig.O2hNl1pWyoDLno0FBNfFRullmSs')